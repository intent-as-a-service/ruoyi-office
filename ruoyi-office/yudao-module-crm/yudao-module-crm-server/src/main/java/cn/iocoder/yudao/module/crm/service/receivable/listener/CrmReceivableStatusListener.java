...
public class CrmReceivableStatusListener extends BpmProcessInstanceStatusEventListener {
    ...
    public void onEvent(@RequestBody BpmProcessInstanceStatusEvent event) {
        receivableService.updateReceivableAuditStatus(Long.parseLong(event.getBusinessKey()), event.getProcessInstanceInfo() != null ? event.getProcessInstanceInfo().getStatus() : null);
    }
