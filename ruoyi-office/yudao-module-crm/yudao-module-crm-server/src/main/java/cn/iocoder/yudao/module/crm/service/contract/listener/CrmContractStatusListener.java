...
public class CrmContractStatusListener extends BpmProcessInstanceStatusEventListener {
    ...
    protected void onEvent(@RequestBody BpmProcessInstanceStatusEvent event) {
        contractService.updateContractAuditStatus(Long.parseLong(event.getBusinessKey()), event.getProcessInstanceInfo() != null ? event.getProcessInstanceInfo().getStatus() : null);
    }
